...
namespace OnlineAuctionAPI.Migrations
{
    ...
    [Migration("20250612030421_ChangeWinnerIdToUser")]
    partial class ChangeWinnerIdToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineAuctionAPI.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OnlineAuctionAPI.Models.AuctionItem", b =>
                {
                    ...
                    b.HasOne("OnlineAuctionAPI.Models.User", "Winner")
                        .WithMany()
            ...
            modelBuilder.Entity("OnlineAuctionAPI.Models.BidItem", b =>
                {
                    ...
                    b.HasOne("OnlineAuctionAPI.Models.AuctionItem", null)
                        .WithOne("WinningBid")
                        .HasForeignKey("OnlineAuctionAPI.Models.BidItem", "AuctionItemId1");
