...
public class UserController : ControllerBase
{
    ...
    public async Task<ActionResult> SuperAdminLogin([FromBody] SuperAdminLoginDto loginDto)
    {
        ...
        // var envEmail = Environment.GetEnvironmentVariable("SUPER_ADMIN_EMAIL");
        // var envPassword = Environment.GetEnvironmentVariable("SUPER_ADMIN_PASSWORD");

        var envEmail = _configuration["SuperAdmin:Email"];
        var envPassword = _configuration["SuperAdmin:Password"];
