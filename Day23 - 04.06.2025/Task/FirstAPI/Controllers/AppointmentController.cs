...
namespace FirstAPI.Controllers
{
    ...
    public class AppointmentController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateAppointment(string appointmentId,[FromBody] AppointmentUpdateRequestDto appointmentDto)
        {
            try
            {
                if (appointmentDto == null)
            ...
            {
                return StatusCode(500, $"Error updating appointment with ID {appointmentId}: {ex.Message}");
            }
        }
