...
public class ExperienceHandler : AuthorizationHandler<ExperienceRequirement>
{
    ...
    public ExperienceHandler(
        ...
        ILogger<ExperienceHandler> logger)
    {
    ...
    protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, ExperienceRequirement requirement)
    {
