...
call proc_create_customer_rental_payment ('Ramuu','Somuu','ramuu_somuu@gmail.com',1,1,1,1,-10)
----------------------------------------------------------------------------

/* Cursors inside the stored procedure, which becomes reuseable in other statments also and there is some benefits like 
